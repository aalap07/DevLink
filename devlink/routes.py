...
from devlink.forms import RegistrationForm, LoginForm, UpdateAccountForm, PostForm
...
def register():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash(
            f'Your account has been created! Your username is {form.username.data}', 'success')
